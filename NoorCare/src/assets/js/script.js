...
//#region Registration, Login, And Forgot Password

function toggleResetPswd(e) {
    e.preventDefault();
    //debugger;
    $('#RegistrationLogInForm .SignInForm').toggle() // display:block or none
    $('#RegistrationLogInForm .ResetForm').toggle() // display:block or none
}
...
function toggleSignUp(e) {
    ...
    //debugger;
    $('#RegistrationLogInForm .SignInForm').toggle(); // display:block or none
    $('#RegistrationLogInForm .SignUpForm').toggle(); // display:block or none
}

$(() => {
    // Login Register Form
    //debugger;
    $('#RegistrationLogInForm #ForgotPassword').click(toggleResetPswd);
    $('#RegistrationLogInForm #ResetCancel').click(toggleResetPswd);
    $('#RegistrationLogInForm #btn_SignUp').click(toggleSignUp);
    $('#RegistrationLogInForm #SignUpCancel').click(toggleSignUp);
})
